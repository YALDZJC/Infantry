...
//pitch
float pitch_Real_Angle;//pitch期望角度,陀螺仪
float pitch_target_angle_gy = 0;//pitch期望角度,陀螺仪
float pitch_target_angle_Encoder = 0;//pitch期望角度,陀螺仪
Kpid_t kpid_pitch_angle(0.3, 0, 0);
Kpid_t kpid_pitch_speed(80, 0, 0);
RM_PID pid_pitch_angle;
RM_PID pid_pitch_speed;
UDE ude_pitch(30, 0.01, 5, 120);
RM_FeedForward FF_pitch;
float FF_pitch_k;
